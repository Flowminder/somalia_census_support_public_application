...
geojson_dir = r"C:\Users\Emily Webb\OneDrive - Lancaster University\Data Science Masters\Placement\mask - Copy - Copy"
...
# Assume same resolution for both
...
# Precompute 4 tile centers from background image extent
...
for filename in sorted(os.listdir(geojson_dir)):
    ...
    area = "baidoa"
    out_image_name = f"training_data_{area}_{tile_id}.tif"
    out_mask_name = f"training_data_{area}_{tile_id}.geojson"
...
print("✅ Done: Created image/mask tiles including background.")
